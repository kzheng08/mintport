...
![A GitBook screenshot showing the personal settings page](../.gitbook/assets/22_01_06_account_settings@2x.png)
...
GitBook can provide you with two types of [notifications](../collaboration/notifications) — email notifications, and in-app notifications. From this settings screen you can decide which kinds of notifications you would like to receive when different events happen.
...
Your personal account could be a member of any number of organizations, and this tab can be considered a shortcut to the [organization settings page](organization-settings) for each organization. You can also create a new organization from this page.
