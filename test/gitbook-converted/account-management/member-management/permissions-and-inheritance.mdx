---
title: "Permissions and inheritance"
description: "GitBook has a flexible permissions model that lets you have as much, or as little, control over permissions as you need. The permission model in GitBook is a ro"
---
...
When you add a member to your organization, you set [their default role](roles). This role applies to any piece of content that inherits its permissions from the organization defaults.
