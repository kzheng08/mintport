...
{/* gitbook: include "../../.gitbook/includes/enterprise-hint.md" %} */}
...
![A GitBook screenshot showing how to configure SSO](../../.gitbook/assets/25_01_10_sso.svg)
...
You must be an [organization admin](../member-management/roles#admin) to enable SSO for your GitBook organization.‌
