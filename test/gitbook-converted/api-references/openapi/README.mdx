...
GitBook supports [Swagger 2.0](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0) or [OpenAPI 3.0](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.3) compliant files.

{/* gitbook: openapi src="https://petstore3.swagger.io/api/v3/openapi. */}
