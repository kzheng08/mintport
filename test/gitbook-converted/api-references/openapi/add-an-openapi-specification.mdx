...
![A GitBook screenshot showing the modal for generating API docs automatically](../../.gitbook/assets/25_12_10_generate_api_docs@2x.png)
...
![A GitBook screenshot showing the Add an OpenAPI specification modal](../../.gitbook/assets/25_12_10_api_spec_modal@2x.png)
