---
title: "Change requests in a space"
description: "Learn about collaborating on a single change request in a space — including how to review, resolve conflicts and merge"
---


# Change requests in a space

When you’re within a [space](../../getting-started/concepts#space), you can make changes by opening a new change request, or browse existing change requests to see what other people are working on.
...
Once you’re happy with your changes, you can use the button in the header bar to [**Request a review**](change-requests-in-a-space#request-a-review-on-a-change-request) of your change request, or [**Merge**](change-requests-in-a-space#merging-a-change-request) it directly into the main branch.

#### Creating a change request with GitBook Agent

[GitBook Agent](../../gitbook-agent/what-is-gitbook-agent) is an AI teammate that can [plan and implement change requests](../../gitbook-agent/write-and-edit-with-ai#implement-a-change-request-with-gitbook-agent) based on any instructions you give it.
...
Head to [Writing with GitBook Agent](../../gitbook-agent/write-and-edit-with-ai) to learn more.
...
When you open a preview URL in a new tab, you will also see [the Preview toolbar](../../resources/gitbook-ui/toolbar-on-published-sites-and-site-previews) at the bottom of the browser window. This toolbar lets you quickly jump back into GitBook to view, edit, or comment on the change request, or open the live version of your site.
...
If your changes don’t require a review, you have the appropriate [permissions](../../account-management/member-management/roles), and you don’t have any blocking [merge rules](../merge-rules), you can merge your changes into the main version directly instead.

<Note>
[Add GitBook Agent as a reviewer](../../gitbook-agent/review-change-requests-with-gitbook-agent) to your change request and it can check your content for spelling, grammar and style guide errors, suggest improvements and more.&#x20;
</Note>
...
Merging a change request will add the change request’s changes into the main branch of content, creating an updated version and a new entry in the space’s [version history](../../creating-content/version-control#see-the-activity-of-a-specific-draft).

You might not be able to merge a change request if you don’t have the right [permissions](../../account-management/member-management/permissions-and-inheritance), or if your change request hasn’t passed your organization or space’s [merge rules](../merge-rules).
