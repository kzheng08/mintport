...
You can receive notifications inside the GitBook app and/or via email. We support [several types of notifications](notifications#notification-types) which you can disable or enable in your notification settings.
