...
By default, expandable blocks will be collapsed on your published docs site. If you want an expandable block to be expanded by default, open the block’s **Options menu** ![](../../.gitbook/assets/25_01_10_options_light.svg) and choose **Expanded by default**.
...
Optionally, you can set expanded blocks to be **Expanded by default** in the block’s **Options menu** ![](../../.gitbook/assets/25_01_10_options_light.svg) — just like this block.
