...
If you want to link to a particular anchor from a page within your GitBook space, you can use a [relative link](../formatting/inline#relative-links), which will update if you change the heading to prevent the link from breaking.
...
To avoid this, you can manually set the anchor link by opening the **Options menu** ![The Options menu icon in GitBook](../../.gitbook/assets/25_01_10_options_light.svg) for the header, then choosing **Edit anchor**. You can then enter the anchor link you wish to use — this will remain the anchor even if you change the header itself.
