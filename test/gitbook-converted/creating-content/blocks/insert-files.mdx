...
{/* gitbook: file src="../../.gitbook/assets/example.pdf" %} */}
...
You can also add files to your space when you add an [image block](insert-images) or an [OpenAPI block](../../api-references/openapi/). When you create one of these blocks, the Files panel will open, so you can either select a file, or upload a new file.
...
To rename a file, open the **Actions menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg) for the file, and click **Edit**. In the dialog prompt, enter the new name of your file.

### Deleting a file

To delete a file, open the **Actions menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg) for the file and click **Delete**. After confirming in the dialog that you’re sure you want to delete the file, your file will be deleted.
