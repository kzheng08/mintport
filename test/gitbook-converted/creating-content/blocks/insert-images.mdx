...
![A photograph taken from space looking back towards Earth. A satellite is in the foreground, and in the background is an ocean-covered part of our planet with patchy clouds.](https://images.unsplash.com/photo-1446776709462-d6b525c57bd3?crop=entropy&#x26;cs=srgb&#x26;fm=jpg&#x26;ixid=M3wxOTcwMjR8MHwxfHNlYXJjaHwyfHxzcGFjZXxlbnwwfHx8fDE3MzMxOTY5NTR8MA&#x26;ixlib=rb-4.0.3&#x26;q=85)
...
Adding more than one image to an image block will create a gallery. To do this, open the block’s **Options menu** ![The Options menu icon in GitBook](../../.gitbook/assets/25_01_10_options_light.svg) and choose **Add images…** to open the **Select images** side panel again.

To delete an image from a gallery, open the **Edit menu** ![](../../.gitbook/assets/25_01_10_edit_icon_light.svg) on the image you want to delete and press the **Delete ⌫** key.
...
To add an image for dark mode, hover over your image, open the **Edit menu** ![](../../.gitbook/assets/25_01_10_edit_icon_light.svg) and click **Replace image** ![The Replace image icon in GitBook](../../.gitbook/assets/25_01_10_replace_image_icon_light.svg).
...
<Warning>
**Note:** GitBook doesn’t currently support light and dark mode images for certain cases, including page covers or image covers on [cards](cards).
</Warning>
...
To resize your image, hover over it and open the **Edit menu** ![](../../.gitbook/assets/25_01_10_edit_icon_light.svg). Click the **Size** button to change the size of your image from the available options.

![A GitBook screenshot showing how to resize an image](../../.gitbook/assets/25_12_10_image_resizing@2x.png)
...
<Note>
You can make image blocks [span the full width of your window](./#full-width-blocks) by clicking on the **Options menu** ![The Options menu icon in GitBook](../../.gitbook/assets/25_01_10_options_light.svg) next to the block and choosing **Full width**.
</Note>
...
To change the alignment of an image, open the block’s **Options menu** ![The Options menu icon in GitBook](../../.gitbook/assets/25_01_10_options_light.svg) and choose the alignment you want. This will only affect images that are narrower than the editor, or images you’ve [resized](insert-images#resizing).
...
![A black and white photograph of a lone figure walking across a stark white landscape](../../.gitbook/assets/25_10_06_image_frame_demo@2x.jpg)

To add a frame to an image, hover over it, open the block’s **Options menu** ![](../../.gitbook/assets/25_01_10_options_light.svg) and enable the **With frame** toggle.
