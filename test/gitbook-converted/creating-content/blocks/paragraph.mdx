...
<Note>
You can [add other inline content](../formatting/inline) to your paragraph, such as emojis, images and Math & TeX.

You can also [format your text](../formatting/) using the context menu or keyboard shortcuts, or using [Markdown](../formatting/markdown).
</Note>
