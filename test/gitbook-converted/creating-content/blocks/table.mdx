...
CompanyStatusContactMRRContactMRRStatus**Ace AI** – DesignIn progress[rena@ace.ai](mailto:noreply@gitbook.com)$450[rena@ace.ai](mailto:noreply@gitbook.com)$420In progress**Discrete Data** – API[dave@dd.inc](mailto:noreply@gitbook.com)$100[dave@dd.inc](mailto:noreply@gitbook.com)$69
...
* **Table/Cards:** Choose to display your data as either a table block or [a cards block](cards). GitBook populates both these blocks using the same data, so you can switch between them depending on the look and design you want.
...
To reorder columns, click and drag on the drag handle ![The table drag handle icon in GitBook](../../.gitbook/assets/25_02_04_actions_horizontal_1.svg) at the top of the column you want to move.
...
Hover over the row and click the **Row options** ![The Row options menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg) button that appears on the left of it to open the **Row options** menu. You’ll see a number of options:
