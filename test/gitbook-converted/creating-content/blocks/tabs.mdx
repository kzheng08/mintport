...
To add a new tab to a tab block, hover over the edge of a tab and click the `+` button that appears. To delete a tab, open the tab’s **Options menu** ![The Options menu icon in GitBook](../../.gitbook/assets/25_01_10_options_light.svg) then select **Delete**.
