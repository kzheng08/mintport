...
![A GitBook screenshot showing the Broken links panel](../.gitbook/assets/25_01_10_broken_links_sidebar.svg)

You can add different [types of links](formatting/inline#links) to your pages in GitBook. If someone has broken a [relative link](formatting/inline#relative-links) while making a change request by updating it or changing its location, you’ll see a notification letting you know there’s something to fix.
