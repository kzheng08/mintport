...
A page is the place where you can add, edit and embed content. Pages always live inside a [space](space), allowing you to group related content and create different sections for the topics or areas you’re covering.

When publishing your documentation, each space will be its own [docs site](../../publishing-documentation/publish-a-docs-site/) or [site section](../../publishing-documentation/site-structure/site-sections), and the pages inside the space will all appear on that site.

### Table of contents

You can create as many pages as you need in a space. They’re all visible on the left sidebar of your screen in your space’s [table of contents](../../resources/gitbook-ui/#table-of-contents). The table of content will appear in the same place when you publish your space, unless [you choose to hide it](page#page-options).
...
When in [live edit](../../collaboration/live-edits) mode or in a [change request](../../collaboration/change-requests/), you can create a new page by clicking **Add new...** > **Page** at the bottom of your table of contents. Alternatively, you can hover between pages in the table of contents and click the **+** icon that appears.

![A GitBook screenshot showing an empty page listed in the table of contents](../../.gitbook/assets/25_12_10_creating_content_content_structure_page@2x.png)

### Can’t see the option to create a new page?

<Warning>
If [live edits](../../collaboration/live-edits) are disabled for your space, you’ll need to create or edit a [change request](../../collaboration/change-requests/). Once you’re in a change request, the **New page** button (which allows you to create pages, page groups and links) will be available in the table of contents.

Alternatively, you may not have the correct [permissions](../../account-management/member-management/permissions-and-inheritance) to edit a page.
</Warning>
...
You can change the title, link title and the slug of a page at any time by clicking opening the page’s **Action menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg) and choosing **Edit title & slug**.
...
Open the page’s **Action menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg) and choose **Edit title & slug**. In the **Edit page** dialog, you'll find the option to enable and define a link title for that page.
...
To change the title and slug of a page group, click the **Action menu** icon ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg) next to the group title in the table of contents and choose **Rename**.
...
You can open the **Page options** ![The Page options menu icon in GitBook](../../.gitbook/assets/25_01_10_options_icon_light.svg) menu or change a page’s cover by hovering over the page title. You’ll see the buttons appear just above the page title.
...
You can hide a page or group of pages from your site's table of contents by opening the page’s **Actions menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg) and toggling **Hide page**.
...
Use **Page options → Metadata** to control how search engines understand relationships between similar pages (for example: documentation versions or [content variants](../../publishing-documentation/site-structure/variants)).
...
You can also set a page cover for each page of your documentation. When you click the **Page cover** ![The Page cover icon in GitBook](../../.gitbook/assets/25_01_10_image_icon_light.svg) option, a default cover will be added immediately. From here, you can:
...
*   **Reposition the cover image**
    ...
    Hover over the page cover and open the **Actions menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg). Click **Reposition**, then drag the image as you wish and click **Save**.
* **Remove the cover image**\
  Hover over the page cover and open the **Actions menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg), then click **Remove**.
* **Full width and hero width**\
  You can change the style of your page cover to span the full width of your screen or just the width of your content. Hover over the page cover and open the **Actions menu** ![The Actions menu icon in GitBook](../../.gitbook/assets/25_01_10_actions_icon_light.svg), then choose your preferred option from the menu.
