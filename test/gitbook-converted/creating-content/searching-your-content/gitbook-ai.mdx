...
<Note>
GitBook AI search is available both within the GitBook app to search internal content, and [in published content to search that specific docs site](../../publishing-documentation/ai-search).&#x20;
</Note>

## GitBook AI helps you find answers in the GitBook app

{/* gitbook: include "../../.gitbook/includes/pro-and-enterprise-hint. */}
...
Once GitBook AI is enabled, open the **Ask or search** ![](../../.gitbook/assets/25_07_16_quick_find.svg) menu from the left sidebar and simply type out a question. GitBook AI will take a few seconds to scan your documentation and summarize the results.
