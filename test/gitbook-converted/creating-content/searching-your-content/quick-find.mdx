...
**​**You can open the **Quick find** palette by hitting the **Quick find** ![](../../.gitbook/assets/25_07_16_quick_find.svg) button at the top of the sidebar or by pressing **⌘ + K** on Mac or **Ctrl + K** on PC.
...
We index your content by grouping it into sections. Sections are denoted using [H1, H2 or H3 Headings](../blocks/heading), with the content that follows them forming part of a section.
