...
description: "By default, when exporting content from GitBook to the Git repository, GitBook will generate a commit message based on the merged change request:"
---
...
![A GitBook screenshot showing autolink setup](../../.gitbook/assets/25_12_10_gitsync_autolink@2x.png)

## Customize the commit message template

When using GitBook with a [monorepo](monorepos), or when you have specific guidelines for commit messages; you might want to customize the message used by GitBook when pushing a commit to Git.
