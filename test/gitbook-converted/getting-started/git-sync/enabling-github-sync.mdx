...
![A GitBook screenshot showing GitHub Sync configuration options](../../.gitbook/assets/25_12_10_git_sync@2x.png)
...
Read more on our [troubleshooting page](troubleshooting#potential-duplicated-accounts-when-signing-in).
</Warning>
...
You’re good to go. You’ll notice that if your space was in [live edit](../../collaboration/live-edits) mode, live edits are now locked. This allows us to reliably sync content to your repository when someone in your team merges a[ change request](../../collaboration/change-requests/) in GitBook.
