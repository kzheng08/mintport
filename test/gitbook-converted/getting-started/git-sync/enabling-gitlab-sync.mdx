...
![A GitBook screenshot showing GitLab Sync configuration options](../../.gitbook/assets/25_12_10_git_sync@2x_1.png)
...
You’re good to go. You’ll notice that if your space was in [live edit](../../collaboration/live-edits) mode, live edits are now locked. This allows GitBook to reliably sync content to your repository when someone in your team merges a[ change request](../../collaboration/change-requests/) in GitBook.
