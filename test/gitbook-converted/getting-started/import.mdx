...
You have the option to import single or multiple pages using our built-in import tool — or [an entire Git repository using Git Sync](import#import-using-git-sync).
...
Alternatively, you can always import a page or subpage by selecting **Add new** > **Import pages** at the bottom of the [table of contents](../resources/gitbook-ui/#table-of-contents), or by opening the **Actions menu** ![The Actions menu icon in GitBook](../.gitbook/assets/25_01_10_actions_icon_light.svg) for a page and choosing **Import subpages**.
