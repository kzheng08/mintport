...
:arrow-down: [Jump to the ‘Publishing’ section on this page](quickstart#publish-your-documentation)
</Check>
</Step>
...
![A screenshot of the Editor in the GitBook app, zoomed in to show the menu that lets you add new pages, groups, links and more to a GitBook space.](../.gitbook/assets/25_11_13_change_request.png)
...
![A screenshot of the GitBook app with the Preview tab open, showing a docs site being previewed on a mobile-size display](../.gitbook/assets/25_11_13_site_preview@2x.png)
...
GitBook supports [Markdown editing](../creating-content/formatting/markdown), so you can create and format content using common syntax.
...
You can [preview your changes](git-sync/github-pull-request-preview) on your published docs site from the pull request in GitHub or GitLab.
...
![A screenshot of the GitBook app showing the version history side panel open. In the side panel the highlighted entry shows a pull request from GitHub that was merged as part of the history, with a link to view the pull request on GitHub.](../.gitbook/assets/25_10_13_github_history@2x.png)
...
![A screenshot of a published docs site hosted on GitBook. The top of the site has a navigation bar, and the cursor is hovering over a drop-down in that bar, with a submenu open below it showing links to more pages](../.gitbook/assets/25_11_13_site_navigation@2x.png)
...
You can customize your site’s [logo, colors and font](../publishing-documentation/customization/icons-colors-and-themes), add to your site navigation bar using [site sections](../publishing-documentation/site-structure/site-sections) and [variants](../publishing-documentation/site-structure/variants), update your [site’s visibility](../publishing-documentation/site-settings#audience) settings and much more.

![An illustration showing five docs sites hosted in GitBook, each with distinct visual customizations](../.gitbook/assets/25_07_16_customization_demo.png)
...
![A screenshot of the GitBook app showing a dashboard for a docs site. The dashboard shows the public URL, site status, site content, some top-level analytics for the site, and other options in tabs along the top of the screen.](../.gitbook/assets/25_11_13_site_dashboard@2x.png)
...
While this may be suitable for some teams, many choose to change their URL to [a custom domain](../publishing-documentation/custom-domain) or [a custom subdirectory](../publishing-documentation/setting-a-custom-subdirectory/).
...
![A screenshot of the GitBook app showing the menu that guides you through the process of setting up a custom domain for your docs site.](../.gitbook/assets/25_11_13_custom_domain@2x.png)
...
Cover imageCover image (dark)Cover image (dark)Cover image (dark)Cover image (dark)Cover image (dark)**Invite your team to collaborate**Add team members to your organization and set permissions[25_12_10_invite_your_team_to_collaborate_1.png](../.gitbook/assets/25_12_10_invite_your_team_to_collaborate_1.png)[invite-members-to-your-organization.md](../account-management/member-management/invite-members-to-your-organization.md)[25_12_10_invite_your_team_to_collaborate.png](../.gitbook/assets/25_12_10_invite_your_team_to_collaborate.png)[25_12_10_invite_your_team_to_collaborate.png](../.gitbook/assets/25_12_10_invite_your_team_to_collaborate.png)**Change site visibility**Control who can see your content with share links and authenticated access[25_12_10_change_site_visibility_1.png](../.gitbook/assets/25_12_10_change_site_visibility_1.png)[#publish-a-docs-site](../publishing-documentation/publish-a-docs-site/#publish-a-docs-site)[25_12_10_change_site_visibility.png](../.gitbook/assets/25_12_10_change_site_visibility.png)[25_12_10_change_site_visibility.png](../.gitbook/assets/25_12_10_change_site_visibility.png)[25_12_10_change_site_visibility.png](../.gitbook/assets/25_12_10_change_site_visibility.png)**Add auto-translations**Create one-click translations that update automatically[25_12_10_add_auto_translations_1.png](../.gitbook/assets/25_12_10_add_auto_translations_1.png)[site-settings.md](../publishing-documentation/site-settings.md)[25_12_10_add_auto_translations.png](../.gitbook/assets/25_12_10_add_auto_translations.png)[25_12_10_add_auto_translations.png](../.gitbook/assets/25_12_10_add_auto_translations.png)**Install integrations**Integrate with your stack and extend functionality with powerful integrations[25_12_10_install_integrations_1.png](../.gitbook/assets/25_12_10_install_integrations_1.png)[Broken link](/broken/pages/b29aoPwtKZKkAO7zajgr)[25_12_10_install_integrations.png](../.gitbook/assets/25_12_10_install_integrations.png)[25_12_10_install_integrations.png](../.gitbook/assets/25_12_10_install_integrations.png)**Add an API reference**Create auto-updating, interactive API reference docs from an API spec[25_12_10_add_an_api_reference_1.png](../.gitbook/assets/25_12_10_add_an_api_reference_1.png)[Broken link](/broken/pages/EAZLjjyX6jX76NFnj71P)[25_12_10_add_an_api_reference.png](../.gitbook/assets/25_12_10_add_an_api_reference.png)**Track docs analytics**Use the built-in insights to measure success and understand user behavior[25_12_10_track_docs_analytics_1.png](../.gitbook/assets/25_12_10_track_docs_analytics_1.png)[insights.md](../publishing-documentation/insights.md)[25_12_10_track_docs_analytics.png](../.gitbook/assets/25_12_10_track_docs_analytics.png)
...
To find out more, check out [our Quickstart guide](quickstart#getting-started) above, or read [the complete guide to creating and publishing documentation in GitBook](https://app.gitbook.com/s/LBGJKQic7BQYBXmVSjy0/editing-and-publishing-documentation/complete-guide-to-publishing-docs-gitbook).
...
While GitBook itself isn’t open source, **open source projects can publish documentation on GitBook for free**. Teams can sign up for [the Community plan](../account-management/plans/community/) and publish content using [a Sponsored site plan](../account-management/plans/community/sponsored-site-plan), both of which are free to qualifying teams.
