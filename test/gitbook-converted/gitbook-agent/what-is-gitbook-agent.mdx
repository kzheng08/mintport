...
<Note>
If you’d like to edit your docs in your local environment using an AI assistant, you can use [GitBook's skill.md file](../creating-content/ai-coding-assistants-and-skillmd).
</Note>
...
**Write with GitBook Agent**Create content based on a prompt or edit a single block[write-and-edit-with-ai.md](write-and-edit-with-ai.md)**Review with GitBook Agent**Ask the Agent to check your work for spelling, grammar and style[review-change-requests-with-gitbook-agent.md](review-change-requests-with-gitbook-agent.md)**Translate your docs site**GitBook Agent can create auto-updating localizations[translations.md](translations.md)
...
You can quickly access this screen by opening the GitBook Agent chat window in a change request, then opening the **Actions menu** ![](../.gitbook/assets/25_01_10_actions_icon_light.svg) and choosing **Configure GitBook Agent** ![](../.gitbook/assets/25_01_10_settings_icon_light.svg).
...
[Translations](translations) are priced separately as a monthly add-on. Visit [the pricing section](translations#pricing) to find out more.





Can I override the default tone of GitBook Agent’s output?
