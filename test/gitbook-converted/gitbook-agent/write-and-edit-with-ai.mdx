---
title: "Writing with GitBook Agent"
...
You can [add your own style guide and custom instructions](what-is-gitbook-agent#add-a-style-guide-and-custom-instructions) at an organization level — so the Agent will always match your tone and style whenever you ask it to help.
</Note>
...
![](../.gitbook/assets/25_12_10_write_and_edit_with_ai@2x.png)
...
![](../.gitbook/assets/26_01_14_improve_page_actions.png)
...
You can access the **Improve** menu from the editor by hovering over the page title, or by opening the page’s **Actions menu** ![](../.gitbook/assets/25_01_10_actions_icon_light.svg).
