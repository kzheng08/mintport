...
![A GitBook screenshot showing the integration library](../.gitbook/assets/26_01_06_integrations@2x.png)
...
![A GitBook screenshot showing where you can install an integration](../.gitbook/assets/25_01_10_install_integration.svg)
