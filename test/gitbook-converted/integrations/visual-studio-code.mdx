...
After saving your personal access token, you’ll need to choose the organization that you’d like to add your [snippets](../snippets/snippets-beta) to.
...
<Note>
This feature requires [GitBook AI Search (beta)](../creating-content/searching-your-content/gitbook-ai) to be enabled for your organization.
</Note>
