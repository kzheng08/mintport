...
![A GitBook screenshot showing the segment editor](../../.gitbook/assets/26_01_06_segment_editor@2x.png)

### Create a segment

To create a new segment, head to the condition editor, and click the settings icon ![The Settings icon in GitBook](../../.gitbook/assets/25_01_10_settings_icon_light.svg) next to an existing segment in the segment dropdown.
...
![A GitBook screenshot showing how to test a segment](../../.gitbook/assets/26_01_06_testing_segments@2x.png)
