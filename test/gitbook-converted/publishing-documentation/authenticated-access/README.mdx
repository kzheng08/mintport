...
![A screenshot showing a login screen for docs behind authenticated access](../../.gitbook/assets/26_01_06_authenticated_access@2x.png)
...
Head to [Enabling authenticated access](enabling-authenticated-access) to start setting up protected access for your site.
