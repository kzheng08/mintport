...
![An Okta screenshot showing the create app integration screen](../../.gitbook/assets/25_04_10_setting_up_okta_1.png)
...
![An Okta screenshot showing the integration setup](../../.gitbook/assets/25_04_10_setting_up_okta_2.png)
...
![An Okta screenshot showing where to copy client credentials](../../.gitbook/assets/25_04_10_setting_up_okta_3.png)
...
![A GitBook screenshot showing the site settings page](../../.gitbook/assets/25_04_10_setting_up_okta_5.png)
...
![A GitBook screenshot showing the Okta credentials modal](../../.gitbook/assets/25_04_10_setting_up_okta_6.png)
...
![An Okta screenshot showing the sign-in redirect URI configuration](../../.gitbook/assets/25_04_10_setting_up_okta_4.png)
...
Once claims are being passed into GitBook, follow the steps in [Adapting your content](../adaptive-content/adapting-your-content) to define what content should be shown to whom.
