...
This setting will _not_ auto-translate your actual content, but it can help match the interface to the language you’re writing in. To learn more about translating your content, head to the [Translations](../../gitbook-agent/translations) section.
...
![](../../.gitbook/assets/25_12_10_configure@2x.png)
...
Enable this option to allow visitors to [export a PDF](../../collaboration/pdf-export) of your documentation.
