...
![A GitBook screenshot showing header customization settings](../../.gitbook/assets/25_12_10_header@2x.png)
...
![A GitBook screenshot showing footer customization settings](../../.gitbook/assets/25_12_10_footer@2x.png)
