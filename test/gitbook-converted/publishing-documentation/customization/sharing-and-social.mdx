...
![Social accounts settings in Site customization](../../.gitbook/assets/26_01_23_social_accounts@2x.png)
...
If your site has multiple [site sections](../site-structure/site-sections), you can use the drop-down menu at the top of the Customization screen to switch between each section and add a custom social preview image for each one.
