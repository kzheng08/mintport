...
description: "Use the Docs Embed with sites that require authentication by passing visitor tokens or using authenticated access"
---
...
* [Customizing the Embed](../configuration/customizing-docs-embed) – Add welcome messages and actions
* [Creating custom tools](../configuration/creating-custom-tools) – Integrate with your product APIs
