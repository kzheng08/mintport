...
After [adding Docs Embed to your website or app](../implementation/README), you can further customize the experience by adding things like actionable buttons to the sidebar, suggestions to nudge your users with contextual questions, and more.

### Customizing the button ([standalone](../implementation/script) only)

When using the [standalone script tag implementation](../implementation/script), you can customize the label and icon of the button that launches the embed widget.

<Note>
This button customization option is only available when using the [standalone script tag implementation](../implementation/script). For [React](../implementation/react) or [Node.js/NPM package](../implementation/nodejs) implementations, you'll need to create your own button to launch the embed.
</Note>
