...
Configure the embed with customization options. See the [Configuration section](../implementation/script#configuration-options) for available options.
...
Configure the embed. See the [Configuration section](../implementation/nodejs#configuration-options) for available options.
...
See the [React integration guide](../implementation/react) for component props and the `useGitBook` hook API.
