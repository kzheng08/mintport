---
title: "Script tag"
description: "Learn how to add the Docs Embed widget to any website or web app using a single script tag"
---
...
Custom AI tools to extend the Assistant. See [Creating custom tools](../configuration/creating-custom-tools) for details.
...
* **Authenticated docs not accessible** – If your docs require sign-in, you must provide the `visitor.token` when initializing. See [Using with authenticated docs](../authentication/using-with-authenticated-docs).
