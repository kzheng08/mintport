...
{/* gitbook: include "../.gitbook/includes/premium-and-ultimate-hint.m */}
...
![A GitBook screenshot showing the site insights dashboard](../.gitbook/assets/26_01_06_insights@2x.png)
...
To view the data over a custom time period, click the **Select custom date range** button ![](../.gitbook/assets/25_09_15_calendar_1.svg) to the right of the menu and choose your custom time period using the calendar that appears.
...
Pages & feedback allow you to see a high-level representation of how your users rate your content. You’ll see an overview of all of your site’s sections and variants, and after enabling [page rating](site-settings#page-ratings-pro-and-enterprise-plans) in the **Customize** menu for a site, you can see each page’s average feedback rating.
...
If a broken link points to a topic that exists somewhere else in your documentation, or you simply want to direct the traffic to your primary docs, you can set up [site redirects](site-redirects) to point those visitors in the right direction.
...
The [Ask AI](../creating-content/searching-your-content/gitbook-ai) section allows you to see what your users are asking for when using GitBook AI. This insight helps you identify common questions, uncover gaps in your documentation, and improve content to better meet user needs.
