...
{/* gitbook: include "../../.gitbook/includes/premium-and-ultimate-hin */}
...
To publish your docs privately, head to the [docs site’s ](../site-settings)settings, click **Audience settings** button, and choose the **Share links** option.
...
<Note>
You can [revoked](share-links#revoke-a-link) and regenerate share links at any time.
</Note>
