---
title: "Configuring a subdirectory with AWS using CloudFront and Route 53"
description: "Host your documentation with a /docs subdirectory using AWS CloudFront and Route 53."
---
