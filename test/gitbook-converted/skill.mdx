---
title: "skill"
description: "A comprehensive guide for editing GitBook documentation in external environments like Cursor, Claude Code, or other text editors. This skill provides all the fo"
---
...
* `&lt;Steps&gt;
...
&lt;/Steps&gt;` for sequential steps
* `<details>...<summary>...</details>` for expandable content

**Links:**

* External: `[text](https://example.com)`
* Internal: Use relative paths like `[text](page)` or `[text](../folder/page)`
...
* [First page's title](page1/README)
    ...
    * [Some other child page](page1/page1-2)
* [Second page's title](page2/README)
    * [Some child page](page2/page2-1)
    * [Some other child page](page2/page2-2)
...
* Each list item should be a markdown link: `[Link text](path/to/file)`
...
 CODE10 javascript title="index.js"
const foo = 'bar';
console.log(foo);
 CODE11 `
...
* Internal pages: Use relative file paths like `[text](page)`, `[text](../folder/page)`, or `[text](subfolder/page)`
...
[https://codepen.io/username/pen/example](https://codepen.io/username/pen/example)
<!-- embed: manual review needed -->
```
...
* Always close blocks properly (`{/* gitbook: endtab %} */}`, `{/* gitbook: endhint %} */}`, etc.)
